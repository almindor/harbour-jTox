...
SODIUMSRC="https://github.com/jedisct1/libsodium/archive/1.0.13.tar.gz"
SODIUMLIBSDIR="$SODIUMDIR/src/libsodium/.libs"
TOXCORESRC="https://github.com/TokTok/c-toxcore/archive/v0.1.10.tar.gz"
...
sb2 -t SailfishOS-$TARGET -m sdk-build make -j 4 &> "$TOXDIR/output.log"
echo "OK"
